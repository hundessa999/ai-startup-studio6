...
export default function Home() {
  return (
    <div style={{"--brandFrom":"#8B5CF6","--brandTo":"#3B82F6"}} className="min-h-screen gradient">
      <div className="container py-24">
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-white/20 backdrop-blur" />
            <span className="text-white text-xl font-semibold">NicheBlog AI</span>
          </div>
          <Link href="/dashboard" className="btn">Open App</Link>
        </header>

        <main className="mt-24 text-white">
          <h1 className="text-5xl md:text-6xl leading-tight drop-shadow">NicheBlog AI</h1>
