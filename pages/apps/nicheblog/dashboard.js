...
export default function Dashboard(){
  ...
  return (
    <div className='min-h-screen bg-slate-900 p-8'>
      <header className='flex items-center justify-between mb-6'><div><h1 className='text-2xl'>NicheBlog AI — Dashboard</h1></div><a className='btn' href='/'>All apps</a></header>
      <div className='grid md:grid-cols-3 gap-6 mt-6'>
        ...
        <div className='card'>
          <img src='/public/screenshots/nicheblog.png' className='rounded' />
        </div>
      </div>
    </div>
  )
